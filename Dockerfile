...
ARG REPLACE_ME_SMTP_USERNAME=echo $(cat password | grep REPLACE_ME_SMTP_USERNAME=) | sed 's/REPLACE_ME_SMTP_USERNAME=//g'
ARG REPLACE_ME_SMTP_PASSWORD=echo $(cat password | grep REPLACE_ME_SMTP_PASSWORD=) | sed 's/REPLACE_ME_SMTP_PASSWORD=//g'
